...
/*
 * Memory-management pacing knobs (defined in zstream_hash.c). These are
 * exposed primarily so tests can exercise memory-pressure behavior at small
 ...
 * number of insertions between memory-budget checks. Changes affect
 * subsequent operations on all tables.
 */
